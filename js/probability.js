...
function stage(e) {
  ...
  let quizImg = `<img src="../images/probability/${stageNum}/Q.png" alt="문제">`
  ...
  for (let i = 0; i < arraLen; i++) {
    ...
    <div class="answer_img">
      <img onclick="mark(this)" class="answerImg" src="../images/probability/${stageNum}/list_answer/${answerNum}.png" alt="${answerNum}.png" name="${answerNum}">
    </div>`
